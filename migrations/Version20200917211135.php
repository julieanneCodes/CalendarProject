 ...
 */
final class Version20200917211135 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE calendar (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, time TIME NOT NULL, day DATE NOT NULL, CONSTRAINT FK_6EA9A146A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('DROP INDEX IDX_E5A02990326BC5F5');
        $this->addSql('CREATE TEMPORARY TABLE __temp__day AS SELECT id, task_day_id FROM day');
        $this->addSql('DROP TABLE day');
        $this->addSql('CREATE TABLE day (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, task_day_id INTEGER DEFAULT NULL, calendar_day_id INTEGER DEFAULT NULL, CONSTRAINT FK_E5A02990326BC5F5 FOREIGN KEY (task_day_id) REFERENCES task (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E5A02990A3A4597A FOREIGN KEY (calendar_day_id) REFERENCES calendar (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO day (id, task_day_id) SELECT id, task_day_id FROM __temp__day');
        $this->addSql('DROP TABLE __temp__day');
        $this->addSql('CREATE INDEX IDX_E5A02990326BC5F5 ON day (task_day_id)');
        $this->addSql('CREATE INDEX IDX_E5A02990A3A4597A ON day (calendar_day_id)');
        ...
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, day DATE DEFAULT NULL, CONSTRAINT FK_527EDB25A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__calendar AS SELECT id, user_id, time, day FROM calendar');
        $this->addSql('DROP TABLE calendar');
        $this->addSql('CREATE TABLE calendar (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, time TIME NOT NULL, day DATE NOT NULL, calendar_id_day_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO calendar (id, user_id, time, day) SELECT id, user_id, time, day FROM __temp__calendar');
        $this->addSql('DROP TABLE __temp__calendar');
        $this->addSql('CREATE INDEX IDX_6EA9A146A76ED395 ON calendar (user_id)');
        $this->addSql('CREATE INDEX IDX_6EA9A1466C997F81 ON calendar (calendar_id_day_id)');
        $this->addSql('DROP INDEX IDX_E5A02990326BC5F5');
        $this->addSql('DROP INDEX IDX_E5A02990A3A4597A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__day AS SELECT id, task_day_id FROM day');
        $this->addSql('DROP TABLE day');
        $this->addSql('CREATE TABLE day (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, task_day_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO day (id, task_day_id) SELECT id, task_day_id FROM __temp__day');
        $this->addSql('DROP TABLE __temp__day');
        $this->addSql('CREATE INDEX IDX_E5A02990326BC5F5 ON day (task_day_id)');
        $this->addSql('DROP INDEX IDX_527EDB25A76ED395');
