 ...
 */
final class Version20210124160746 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE calendar (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, time TIME NOT NULL, day DATE NOT NULL, notes VARCHAR(100) DEFAULT NULL COLLATE BINARY, eventname VARCHAR(20) NOT NULL COLLATE BINARY, secondday DATE NOT NULL, secondtime TIME NOT NULL, CONSTRAINT FK_6EA9A146A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, view_config_id INTEGER DEFAULT NULL, email VARCHAR(180) NOT NULL COLLATE BINARY, name VARCHAR(30) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_8D93D649A755C202 FOREIGN KEY (view_config_id) REFERENCES view_config (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
