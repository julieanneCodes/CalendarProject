 ...
 */
final class Version20200917210738 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__day AS SELECT id FROM day');
        ...
        $this->addSql('INSERT INTO day (id) SELECT id FROM __temp__day');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, user_id, day_task_id_id, day FROM task');
        ...
        $this->addSql('INSERT INTO task (id, user_id, day_task_id_id, day) SELECT id, user_id, day_task_id_id, day FROM __temp__task');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, user_id, day_task_id_id, day FROM task');
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, day_task_id_id INTEGER DEFAULT NULL, day DATE DEFAULT NULL)');
        $this->addSql('INSERT INTO task (id, user_id, day_task_id_id, day) SELECT id, user_id, day_task_id_id, day FROM __temp__task');
        $this->addSql('DROP TABLE __temp__task');
        $this->addSql('CREATE INDEX IDX_527EDB25A76ED395 ON task (user_id)');
        $this->addSql('CREATE INDEX IDX_527EDB259E6005A8 ON task (day_task_id_id)');
