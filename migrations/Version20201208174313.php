 ...
 */
final class Version20201208174313 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, day DATE DEFAULT NULL, notes VARCHAR(100) NOT NULL COLLATE BINARY, taskname VARCHAR(20) NOT NULL, CONSTRAINT FK_527EDB25A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO task (id, user_id, day, taskname, notes) SELECT id, user_id, day, task_name, notes FROM __temp__task');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, day DATE DEFAULT NULL, notes VARCHAR(100) NOT NULL, task_name VARCHAR(20) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO task (id, user_id, day, task_name, notes) SELECT id, user_id, day, taskname, notes FROM __temp__task');
        $this->addSql('DROP TABLE __temp__task');
        $this->addSql('CREATE INDEX IDX_527EDB25A76ED395 ON task (user_id)');
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74');
        $this->addSql('DROP INDEX IDX_8D93D649A755C202');
