 ...
 */
final class Version20201111182828 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_config (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, panel_view VARCHAR(10) NOT NULL)');
