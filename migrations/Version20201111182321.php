 ...
 */
final class Version20201111182321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_config AS SELECT id, panel_view FROM user_config');
        $this->addSql('DROP TABLE user_config');
        $this->addSql('CREATE TABLE user_config (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, panel_view INTEGER NOT NULL)');
        $this->addSql('INSERT INTO user_config (id, panel_view) SELECT id, panel_view FROM __temp__user_config');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_config AS SELECT id, panel_view FROM user_config');
        $this->addSql('DROP TABLE user_config');
        $this->addSql('CREATE TABLE user_config (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, panel_view INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, color VARCHAR(10) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user_config (id, panel_view) SELECT id, panel_view FROM __temp__user_config');
        $this->addSql('DROP TABLE __temp__user_config');
