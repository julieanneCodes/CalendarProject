 ...
 */
final class Version20200917210900 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__calendar AS SELECT id, user_id, calendar_id_day_id, time, day FROM calendar');
        ...
        $this->addSql('INSERT INTO calendar (id, user_id, calendar_id_day_id, time, day) SELECT id, user_id, calendar_id_day_id, time, day FROM __temp__calendar');
        ...
        $this->addSql('CREATE TABLE day (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, task_day_id INTEGER DEFAULT NULL, CONSTRAINT FK_E5A02990326BC5F5 FOREIGN KEY (task_day_id) REFERENCES task (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__calendar AS SELECT id, user_id, calendar_id_day_id, time, day FROM calendar');
        $this->addSql('DROP TABLE calendar');
        $this->addSql('CREATE TABLE calendar (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, calendar_id_day_id INTEGER DEFAULT NULL, time TIME NOT NULL, day DATE NOT NULL)');
        $this->addSql('INSERT INTO calendar (id, user_id, calendar_id_day_id, time, day) SELECT id, user_id, calendar_id_day_id, time, day FROM __temp__calendar');
        $this->addSql('DROP TABLE __temp__calendar');
        $this->addSql('CREATE INDEX IDX_6EA9A146A76ED395 ON calendar (user_id)');
        $this->addSql('CREATE INDEX IDX_6EA9A1466C997F81 ON calendar (calendar_id_day_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, user_id, day FROM task');
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, day DATE DEFAULT NULL, day_task_id_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO task (id, user_id, day) SELECT id, user_id, day FROM __temp__task');
        $this->addSql('DROP TABLE __temp__task');
        $this->addSql('CREATE INDEX IDX_527EDB25A76ED395 ON task (user_id)');
